<template>
	<div class="z-10 absolute top-0 right-0 bottom-0 left-0 flex justify-center items-center">
		...
		<div class="relative">
			<h2 class="w-full my-2 text-2xl leading-tight text-center text-white">Sur quel joueur souhaitez-vous utiliser cette carte ?</h2>
			<div class="flex items-center justify-center">
				<div class="inline-block relative w-64 m-2">
					<select v-model="selectedTargetId" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
			...
			<h2 class="w-full my-2 text-2xl leading-tight text-center text-white">Quelle est votre supposition?</h2>
			<div class="flex items-center justify-center">
				<div class="inline-block relative w-64 m-2">
					...
					<select v-model="selectedCardValue" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
						<option value="0">Espionne</option>
						<option value="1">Garde</option>
						<option value="2">Prêtre</option>
						<option value="3">Baron</option>	
						<option value="4">Servante</option>
						<option value="5">Prince</option>
						<option value="6">Chancelier</option>
						<option value="7">Roi</option>
						<option value="8">Comtesse</option>
						<option value="9">Princesse</option>
					</select>
					<div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
						<svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z"/></svg>
					</div>
